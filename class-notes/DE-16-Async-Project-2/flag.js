    ...
    document.querySelector(".countries").innerHTML += `
     ...
     <div class="card text-start w-50 shadow-lg bg-light">
      ...
      <ul class="list-group list-group-flush">
         <li class="list-group-item"><i class="fas fa-lg fa-landmark"></i> ${ülke.capital
        }  </li>
          ...
          <li class="list-group-item"><i class="fas fa-lg fa-money-bill-wave"></i> ${Object.values(ülke.currencies)[0].name
        } </li>
